    ...
    config = function()
            require('gitsigns').setup{
                ...
                on_attach = function(bufnr)
                    ...
                    map('v', '<leader>hs', function() gitsigns.stage_hunk {vim.fn.line('.'), vim.fn.line('v')} end, { desc = "Git stage hunk (visual)" })
                    map('v', '<leader>hr', function() gitsigns.reset_hunk {vim.fn.line('.'), vim.fn.line('v')} end, { desc = "Git reset hunk (visual)" })
